...
with c2:
    upload_p = st.file_uploader("Upload a past or other Contract")

upsert = st.button("Load your Documents", type="primary", )
run    = st.button("Compare your Documents", type="primary")
